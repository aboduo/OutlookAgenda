...
class AgendaEventsDataSource {
    ...
    static private var agendaEvents: [String: [AgendaEvent]] = {
        ...
        let event0 = AgendaEvent(title: "I'm title", content: "I'm content", dateInterval: dateInterval0, participants: nil, location: "ShangHai")
        let event1 = AgendaEvent(title: "我是标题", content: "我不是内容", dateInterval: dateInterval1, participants: participants, location: nil)
        let event2 = AgendaEvent(title: "我是标题很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长很长", content: "我不是内容", dateInterval: dateInterval2, participants: participants, location: "我是地址，很长很长很长很长很长很长很长很长很长很长很长很长很长")
